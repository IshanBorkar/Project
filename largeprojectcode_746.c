...
int forward(float value[],float neth[], float outh[], float neto[],float outo[],float E[]);
int backward(float value[],float neth[], float outh[], float neto[],float outo[],float E[],float de[],float douto[],float dneto[],float dE[],float dEo11[],float dEo1[],float dEo22[],float dEo2[],float dEt[],float douth1[],float dneth1[],float dE1[],float dEo111[],float dneto11[],float dneto12[],float dEo222[]);


int main()
{
        FILE *f=fopen("/home/mtech/Desktop/click_746.txt", "r");
  
	int  col, item;        	
	float value[COL],neth[COL],outh[COL],neto[COL],outo[COL],E[COL];
	...
	float b1=0.35,b2=0.60, x=0,eta=0.5;
	...
	{
        readresults(f, value);
        forward(value,neth,outh,neto,outo,E);
        backward(value,neth,outh,neto,outo,E,de,douto,dneto,dE,dEo11,dEo1,dEo22,dEo2,dEt,douth1,dneth1,dE1,dEo111,dneto11,dneto12,dEo222);
	}
	...
	printf("\nTime Taken in Seconds for Serial Computation for 746 MB dataset      :%lf \n  ", time_overhead);
...
forward(float value[],float neth[], float outh[], float neto[],float outo[],float E[])
{ 	
	int col,item;
...
backward(float value[],float neth[], float outh[], float neto[],float outo[],float E[],float de[],float douto[],float dneto[],float dE[],float dEo11[],float dEo1[],float dEo22[],float dEo2[],float dEt[],float douth1[],float dneth1[],float dE1[],float dEo111[],float dneto11[],float dneto12[],float dEo222[])
{	int col,item;
